...
We dont need the numberging below, but moslty to keep track
}}

\hypertarget{why}{%
\subsubsection{1. Why}\label{why}}

When seeing graphemes of an alphabet or a script that we are unfamiliar with, a natural reaction is to be in awe at how readers of that script can distingush among the letters that to us seem \enquote{all alike}.
